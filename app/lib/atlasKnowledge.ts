...
- This portfolio also includes a **live in-browser demo** of the same EAR → alert loop (68-point eye landmarks → Eye Aspect Ratio → alert after eyes stay closed); nothing is uploaded. The project card animation on the site illustrates blink / sleep / alert / wake.
