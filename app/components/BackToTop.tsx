    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-40 flex h-11 w-11 cursor-pointer items-center justify-center rounded-full border border-sky-200 bg-white text-sky-900 shadow-lg shadow-sky-900/15 transition-all duration-300 hover:-translate-y-1 hover:bg-sky-50 hover:text-sky-950 hover:shadow-xl hover:shadow-sky-900/25 md:h-12 md:w-12 dark:border-slate-700 dark:bg-slate-800 dark:text-sky-200 dark:shadow-black/40 dark:hover:bg-slate-700 dark:hover:text-sky-100 dark:hover:shadow-black/60"
        >
